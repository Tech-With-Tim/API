...
def piston_url() -> typing.Optional[str]:
    """URL of the Piston API."""
    value = os.environ.get("PISTON_URL", "https://emkc.org/api/v2/piston/")

    if not value:
        log.warning('Optional environment variable "PISTON_URL" is missing')
